...
class Test_LaserArray(unittest.TestCase):
    ...
    def test_set(self):
        ...
        self.assertEqual(self.ipc.event, MidiEvent(3, 'control_change', control=4, value=64))
    ...
    def test_set_all(self):
        ...
        # test if a message was sent
        self.assertEqual(self.ipc.event, MidiEvent(3, 'control_change', control=127, value=101))
    ...
    def test_stack(self):
        ...
        self.assertEqual(self.ipc.event, MidiEvent(3, 'control_change', control=3, value=127))
